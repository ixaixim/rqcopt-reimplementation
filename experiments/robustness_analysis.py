...
# 20 qubit
# riemannian_path = REPO_ROOT / "experiments/riemannian_adam/data/run_riemannian-opt_20260409_205008.json"
# 6 qubit : 21 effective layers
riemannian_path = REPO_ROOT / "experiments/riemannian_adam/data/run_riemannian-opt_20260410_154421.json"

# 20 qubit 
# hf_path = REPO_ROOT / "experiments/rzz_ising_experiment/data/run_ising-hw-friendly_20260410_155214.json"
# 6 qubit : 20 effective layers (9 reps)
hf_path = REPO_ROOT / "experiments/rzz_ising_experiment/data/run_ising-hw-friendly_20260410_155015.json"

# Load data
target_mpo = MPO.load_json(target_path)
circ_riemannian_su4 = load_experiment_json(riemannian_path)["circuit"]
circ_hf = load_experiment_json(hf_path)["circuit"]

print(f"Loaded target MPO from {target_path}")
print(f"Loaded Riemannian SU(4) circuit from {riemannian_path.name}")
print(f"Loaded Hardware-Friendly circuit from {hf_path.name}")
